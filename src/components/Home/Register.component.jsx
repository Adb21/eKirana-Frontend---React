        ...
        <div>
            ...
            <div className='login-block'>
                ...
                <div className='first_name'>
                    ...
                    <input type="text" name="first_name" id="first-name" onChange={handleInput}/>
                </div>
                ...
                <div className='Locality'>
                    ...
                    <input type="text" name="Locality" id="Locality" onChange={handleInput}/>
                </div>
                <div className='City'>
                ...
                <div className='State'>
                    ...
                    <input type="text" name="State" id="State" onChange={handleInput}/>
                </div>
                <div className='Pincode'>
                    <label htmlFor="Pincode"><b>Set your Pincode</b></label><br />
                    <input type="text" name="Pincode" id="Pincode" onChange={handleInput}/>
                </div>
                ...
                <div className='password2'>
                    ...
                    <input type="password" name="password2" id="password2" onChange={handleInput}/>
                </div>
